...
namespace SLZ.Marrow.Interaction
{
	...
	public class MarrowEntity : MonoBehaviour, ITaggable, IPoolable
	{
		...
		public static ComponentCache<MarrowEntity> Cache => null;
		...
		public IReadOnlyList<MarrowEntity> ConnectedEntities => null;

		public MarrowBody AnchorBody => null;

		public MarrowBody[] Bodies => null;

		public MarrowJoint[] Joints => null;
		...
		public IReadOnlyList<MarrowJoint> RuntimeJoints => null;
